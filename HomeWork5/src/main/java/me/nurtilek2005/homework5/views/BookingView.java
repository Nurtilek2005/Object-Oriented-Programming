package me.nurtilek2005.homework5.views;

import me.nurtilek2005.homework5.models.Table;
import me.nurtilek2005.homework5.presenters.View;
import me.nurtilek2005.homework5.presenters.ViewObserver;
...
public class BookingView implements View {
    ...
    @Override
    public void printReservationTableChangeResult(int reservationNo) {
        System.out.printf("Бронирование столика изменён. Номер вашей брони: #%d\n", reservationNo);
    }

    @Override
    public void printReservationTableChangeError(String errorMessage) {
        System.out.printf("Невозможно поменять бронирование. \n%s\n", errorMessage);
    }
